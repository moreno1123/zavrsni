<div x-cloak x-data="{ isOpen: false }" x-show="isOpen" @keydown.escape.window="isOpen = false" @custom-show-mark-idea-as-not-spam-modal.window="
        isOpen = true
                ...
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">
                            Resetiraj brojač spamova
                        </h3>
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                Jeste li sigurni da želite resetirati spam? Broj spamova će se vratiti na 0.
                            </p>
                        </div>
                    </div>
                </div>
